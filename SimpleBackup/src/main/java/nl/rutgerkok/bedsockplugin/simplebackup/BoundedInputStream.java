...
/**
 * An {@code InputStream} wrapper that provides up to a maximum number of bytes
 * from the underlying stream. Does not support mark/reset, even when the
 * wrapped stream does, and does not perform any buffering.
 *
 * <p>
 * <a href="https://stackoverflow.com/a/28119691" target="_blank">Source</a>
 */
final class BoundedInputStream extends InputStream {
    ...
    /**
     * Initializes a new {@code BoundedInputStream} with the specified underlying
     * stream and byte limit
     * 
     * @param data
     *            the @{code InputStream} serving as the source of this one's data
     * @param maxBytes
     *            the maximum number of bytes this stream will deliver before
